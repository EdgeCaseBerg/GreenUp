<?php
/*  Simple Auth Authorization Endpoint Prototype. 
 ...
 * request was invalid and they should rethink their choices in life.
*/
...
try{
	$token = $database->auth( $jsRequest->id,  $jsRequest->us );
