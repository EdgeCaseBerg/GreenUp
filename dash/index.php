...
if(isset($_POST['username']) && isset($_POST['password'])){
    ...
    curl_setopt($ch, CURLOPT_URL,            "http://".HOST."/dash-auth/api/auth.php" );
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse">
        ...
        <ul class="nav navbar-nav navbar-right">
            <? if($LOGGEDIN){
                    ...
                    echo "<li><button type=\"button\"  onclick=\"location.href = 'https://donatenow.networkforgood.org/greenupvermont';\" id=\"donateButton\" class=\"navButtons btn btn-default btn-md\">Donate</button></li>";
