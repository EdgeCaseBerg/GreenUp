...
-(id)initWithMessage:(NetworkMessage *)messageObject isBackwards:(BOOL)backwards isFirst:(BOOL)first andResueIdentifier:(NSString *)reuseIdentifier
{
    if(self = [super initWithStyle:UITableViewCellStyleDefault reuseIdentifier:reuseIdentifier])
    {
        ...
        if([messageObject.messageType isEqualToString:Message_Cell_Type_A])
        {
            //Top Slice
        ...
        else if([messageObject.messageType isEqualToString:Message_Cell_Type_B])
        {
            //Top Slice
        ...
        else if([messageObject.messageType isEqualToString:Message_Cell_Type_C])
        {
            //Top Slice
