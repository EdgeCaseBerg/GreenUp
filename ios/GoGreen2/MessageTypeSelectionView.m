...
-(id)initWithWindowFrame:(CGRect)windowFrame andCurrent:(NSString *)current
{
    ...
    if (self)
    {
        ...
        if([current isEqualToString:Message_Cell_Type_A])
        {
            [trashButton setBackgroundColor:[UIColor greenColor]];
            self.currentType = Message_Cell_Type_A;
        }
        ...
        if([current isEqualToString:Message_Cell_Type_B])
        {
            [forumButton setBackgroundColor:[UIColor greenColor]];
            self.currentType = Message_Cell_Type_B;
        }
